...
final class LatePoint {
  ...
  public function init() {
    ...
    if(OsSettingsHelper::is_using_stripe_payments() && class_exists('OsPaymentsStripeHelper')){
      OsPaymentsStripeHelper::set_api_key();
    }elseif(OsSettingsHelper::is_using_braintree_payments() && class_exists('OsPaymentsBraintreeHelper')){
